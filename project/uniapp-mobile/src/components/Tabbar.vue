<template>
  <view class="position-fixed bottom-0 flex grid-justify-around w-screen bg-white h-15 grid-items-center">
    <view
      v-for="(item,index) in tabBarList"
      :key="item.pagePath"
      class="flex flex-col flex-justify-items-center grid-items-center"
