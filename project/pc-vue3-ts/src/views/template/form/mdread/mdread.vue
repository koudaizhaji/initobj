<template>
  <el-container>
    ...
    <el-main>
      <MdPreview :model-value="state.text" :editor-id="state.id" :theme="state.theme" />
    </el-main>
...
function handleScroll() {
  ...
  console.log('11111111111', documentScrollTop)
  if (iTarget > 3000) {
...
const renderContent = (h, { node, data, store }) => {
  ...
  return h('div', [h('span', {}, data.label), h('div', {}, data.description)])
}
// 左侧菜单点击
...
async function getMarkdownClass() {
  ...
  // console.log('res',res)
  state.text = res[0].children[6].content
