...
import todayImage from '@/assets/imgs/welcome/today.png'
import yesterdayImage from '@/assets/imgs/welcome/yesterday.png'
import weekImage from '@/assets/imgs/welcome/week.png'
import mouthImage from '@/assets/imgs/welcome/mouth.png'
const arr = [
